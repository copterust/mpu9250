    ...
    where DEV: Device<Error = E> + AK8963<Error = E> + NineDOFDevice
{
    ...
    pub fn magnetometer_healthy(&mut self) -> Result<bool, E> {
        ...
        let control = AK8963::read(&mut self.dev, ak8963::Register::CNTL1)? & 0b11110000;
        ...
        AK8963::write(&mut self.dev, ak8963::Register::CNTL1, control | 0b00001000)?;
        // (4) Check Data Ready or not by any of the following method.
        // - Polling DRDY bit of ST1 register
        while AK8963::read(&mut self.dev, ak8963::Register::ST1)? & 0b00000001 != 0 {}
